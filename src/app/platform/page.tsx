    ...
    <PageWithChat pageContext="platform">
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 pt-16">
          {/* Hero Section */}
          <HighlightableSection sectionId="platform-hero" className="relative py-20 lg:py-28 bg-gradient-to-b from-arq-deep-blue to-arq-slate overflow-hidden">
            {/* Background Pattern */}
          ...
          {/* The Problem */}
          <HighlightableSection sectionId="platform-problem">
          ...
          <HighlightableSection sectionId="platform-capabilities">
          ...
          <HighlightableSection sectionId="platform-architecture">
            <SectionWrapper className="bg-white">
              <Container>
          ...
          {/* Integration Story */}
          <HighlightableSection sectionId="platform-integrations">
          ...
          {/* Why ArqAI Wins */}
          <HighlightableSection sectionId="platform-comparison">
            <SectionWrapper className="bg-white">
              <Container>
                <SectionHeader
